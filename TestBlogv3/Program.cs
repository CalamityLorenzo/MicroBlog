...
namespace TestBlogv3
{
    internal class Program
    {
        ...
        private static async Task DoThings(IConfigurationSection appKeys)
        {
            ...
            //var blogOh1 = new BlogEntry("https", "string bling", "synthOio", "article", "Pal lawrence", new List<string> { "Salad", "Fortune", "Cava" }, new List<string> { "Science", "MAths", "Boojagger" }, DateTime.Now, DateTime.Today.AddDays(-100));
            ...
            //var results = new BlogEntry(await bs.Get(entity.Id), createdTags, 
